...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='LMAT-1.2.X fastsummary results to CC input',
        epilog='lmat2cmplx - by J.Mn.Marti.M. - ' + _verdata
    )
    parser.add_argument(
        '-V', '--version',
        action='version',
    ...
    conv = LMAT2CC(args)
    conv.parse('1')  # For LMAT taxonomical classification
    conv.parse('2')  # For LMAT content summarization
