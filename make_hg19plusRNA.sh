...
#
# Downloads sequence for the hg19 version of H. sapiens sapiens (human)
# from UCSC.
#
...
chrY \
chrM \
rna" # Added RNA.fa got from ftp://ftp.ncbi.nih.gov/refseq/H_sapiens/H_sapiens/RNA/
...
BOWTIE_BUILD_EXE=~/ratsvm/bowtie2/bowtie2-build
...
CMD="${BOWTIE_BUILD_EXE} ${INPUTS} hg19plusRNA"
echo Running $CMD
if $CMD ; then
	echo "hg19plusRNA index built; you may remove fasta files"
else
